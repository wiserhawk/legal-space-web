...
@Component({
  selector: 'address-proof-affidavit',
  templateUrl: './address-proof-affidavit.component.html',
  styleUrls: ['./address-proof-affidavit.component.css']
})
export class AddressProofAffidavitComponent {
