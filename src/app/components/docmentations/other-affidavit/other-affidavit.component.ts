...
@Component({
  selector: 'other-affidavit',
  templateUrl: './other-affidavit.component.html',
  styleUrls: ['./other-affidavit.component.css']
})
export class OtherAffidavitComponent {
  ...
  private createMessage() {
    return {
      affidavitName: this.model.affidavitName,
      affidavitDetails: this.model.affidavitDetails,
