...
@Component({
  selector: 'domicile-affidavit',
  templateUrl: './domicile-affidavit.component.html',
  styleUrls: ['./domicile-affidavit.component.css']
})
export class DomicileAffidavitComponent {
  ...
  private createMessage() {
    return {
      ...
      nameOfState: this.model.nameOfState,
      applicantAddress: this.model.applicantAddress,
      residentSince: this.model.residentSince,
