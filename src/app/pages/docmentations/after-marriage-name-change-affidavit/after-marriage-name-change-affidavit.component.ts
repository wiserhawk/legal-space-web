...
@Component({
  selector: 'after-marriage-name-change-affidavit',
  templateUrl: './after-marriage-name-change-affidavit.component.html',
  styleUrls: ['./after-marriage-name-change-affidavit.component.css']
})
export class AfterMarriageNameChangeAffidavitComponent {
  ...
  private validateStep1() : boolean {
    ...
    if (this.isEmpty(this.model.spouseName)) {
      this.error = true
      this.errorFields.push('spouseName')
    }
    ...
    if (this.isEmpty(this.model.placeOfMarriage)) {
      this.error = true
      this.errorFields.push('placeOfMarriage')
    }
    if (this.isEmpty(this.model.dateOMarriage)) {
      this.error = true
      this.errorFields.push('dateOMarriage')
    }
  ...
  private createMessage() {
    return {
      ...
      placeOfMarriage: this.model.placeOfMarriage,
      dateOMarriage: this.model.dateOMarriage,
