...
@Component({
  selector: 'signature-change-affidavit',
  templateUrl: './signature-change-affidavit.component.html',
  styleUrls: ['./signature-change-affidavit.component.css']
})
export class SignatureChangeAffidavitComponent {
  ...
  private createMessage() {
    return {
      ...
      monthsSignChangedSince: this.model.monthsSignChangedSince,
