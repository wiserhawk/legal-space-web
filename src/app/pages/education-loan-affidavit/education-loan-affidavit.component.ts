...
@Component({
  selector: 'education-loan-affidavit',
  templateUrl: './education-loan-affidavit.component.html',
  styleUrls: ['./education-loan-affidavit.component.css']
})
export class EducationLoanAffidavitComponent {
  ...
  private createMessage() {
    return {
      ...
      universityName: this.model.universityName,
      courseDuration: this.model.courseDuration,
      courseBeginDate: this.model.courseBeginDate,
      annualFamilyIncome: this.model.annualFamilyIncome,
